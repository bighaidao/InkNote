  ...
  return [
    {
      ...
      keys: [
        ...
        "settings.externalOpenMode", "settings.externalOpenModeDesc",
              ...
              <>
                {activeCategory === "general" && (
                  <SettingsPage title={tr("settings.section.general")}>
                    ...
                    <SettingItem label={tr("settings.externalOpenMode")} desc={tr("settings.externalOpenModeDesc")}>
                      <select
                        value={values.externalOpenReadOnly ? "preview" : "edit"}
                        onChange={(event) => handlers.onExternalOpenReadOnly(event.target.value === "preview")}
                      >
                        <option value="preview">{tr("documentAccess.preview")}</option>
                        <option value="edit">{tr("documentAccess.edit")}</option>
                      </select>
                    </SettingItem>
